...
<%
	...
	%>
	<div class="alert alert-info" font-size: 80%;>
  <strong><center><I>Welcome to Checklist</I></center></strong>
</div>
<div class="alert alert-warning">
  <strong><center><I>Sign In</I></center></strong>
</div>
    <div class="container">    
                        ...
                        <div style="display:none" id="login-alert" class="alert alert-danger col-sm-12"></div>
                          ...
                          <form name='loginForm' action="<c:url value='login' />" method='POST'>          
                            <div style="margin-bottom: 25px" class="input-group">
                                        ...
                                        <input id="login-username" type="text" class="form-control" name="username" placeholder="Employee ID">         
        ...
        <div class="container row" font-size: 100%;>
    <div class="Copyright-Txt  footer ">
   <center><b>Copyright 2014. InterGlobe Technologies. </b></center>
  </div>
